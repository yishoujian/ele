...
class CreateMenusTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('menus', function (Blueprint $table) {
            ...
            $table->string("logo")->comment("商品图片");
            $table->integer("status")->comment("状态 1上架 0 下架");
